...
Game.prototype.endtimer = function(){
    ...
    document.getElementById("final-countdown").innerText = "Redirecting to room in " + String(this.endtime)
}
...
Game.prototype.end = function(){
    ...
    document.getElementById("final-countdown").innerText = "Redirecting to lobby in " + String(this.endtime)
